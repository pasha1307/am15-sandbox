...
export declare class MultiInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    constructor(ref: ElementRef<MultiInput>);
    private eventHandlers;
    nativeElement: MultiInput;
