...
export default function(options: Schema): Rule {
  return (host: Tree, context: SchematicContext) => {
    ...
    const smartVersionRange = getPackageVersionFromPackageJson(host, 'smart-webcomponents-angular');
    ...
    if (smartVersionRange === null) {
      addPackageToPackageJson(host, 'smart-webcomponents-angular', fallbackSmartVersionRange);
    }
