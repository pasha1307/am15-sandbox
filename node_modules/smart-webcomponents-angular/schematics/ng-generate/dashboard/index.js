...
function addTableModulesToModule(options) {
    return (host) => __awaiter(this, void 0, void 0, function* () {
        ...
        schematics_2.addModuleImportToModule(host, modulePath, 'SplitterModule', 'smart-webcomponents-angular/splitter');
        schematics_2.addModuleImportToModule(host, modulePath, 'GridModule', 'smart-webcomponents-angular/grid');
        schematics_2.addModuleImportToModule(host, modulePath, 'ChartModule', 'smart-webcomponents-angular/chart');
        schematics_2.addModuleImportToModule(host, modulePath, 'CalendarModule', 'smart-webcomponents-angular/calendar');
        schematics_2.addModuleImportToModule(host, modulePath, 'ListBoxModule', 'smart-webcomponents-angular/listbox');
        schematics_2.addModuleImportToModule(host, modulePath, 'DateTimePickerModule', 'smart-webcomponents-angular/datetimepicker');
        schematics_2.addModuleImportToModule(host, modulePath, 'ButtonModule', 'smart-webcomponents-angular/button');
        schematics_2.addModuleImportToModule(host, modulePath, 'RadioButtonModule', 'smart-webcomponents-angular/radiobutton');
        schematics_2.addModuleImportToModule(host, modulePath, 'TextBoxModule', 'smart-webcomponents-angular/textbox');
     });
}
