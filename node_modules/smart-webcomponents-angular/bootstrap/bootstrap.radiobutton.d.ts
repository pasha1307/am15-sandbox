...
import { BootstrapRadioButtonStyleMode } from './../index';
...
export declare class BootstrapRadioButtonComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    constructor(ref: ElementRef<BootstrapRadioButton>);
    private eventHandlers;
    nativeElement: BootstrapRadioButton;
