...
import { BootstrapTextareaStyleMode } from './../index';
...
export declare class BootstrapTextareaComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    constructor(ref: ElementRef<BootstrapTextarea>);
    private eventHandlers;
    nativeElement: BootstrapTextarea;
