...
.smart-window.smart-kanban-window[readonly] .smart-multi-combo-input .smart-drop-down-button, .smart-window.smart-kanban-window[readonly] .smart-multi-combo-input .smart-drop-down-list-unselect-button {
  display: none;
}
