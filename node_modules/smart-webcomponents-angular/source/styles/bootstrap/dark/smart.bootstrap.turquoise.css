...
smart-repeat-button.primary {
  ...
  --smart-ui-state-hover: #00a8ab;
  --smart-ui-state-border-hover: #009c9e;
  --smart-ui-state-active: #00a8ab;
  --smart-ui-state-border-active: #009c9e;
  --smart-ui-state-focus: #00a8ab;
  --smart-ui-state-border-focus: #009c9e;
}
...
smart-repeat-button.link {
  ...
  --smart-border-rgb: 0, 206, 209;
  --smart-background-color: #00CED1;
  --smart-ui-state-hover: transparent;
  --smart-ui-state-border-hover: transparent;
  --smart-ui-state-color-hover: #00CED1;
  --smart-ui-state-active: transparent;
  --smart-ui-state-border-active: transparent;
  --smart-ui-state-color-active: #00CED1;
  --smart-ui-state-focus: transparent;
  --smart-ui-state-border-focus: transparent;
  --smart-ui-state-color-focus: #00CED1;
  --smart-button-flat-color: #00CED1;
  --smart-button-outlined-color: #00CED1;
...
.smart-grid [check-boxes_visible] [has-toggle-button] .smart-input:not(.smart-grid-cell-editor):hover[focus] {
  box-shadow: 0 0 0 0.25rem #00CED1;
  /*Fallback */
...
/*# sourceMappingURL=smart.bootstrap.turquoise.css.map */
